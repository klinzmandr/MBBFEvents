...
// same for second site field
  ...
  sqlupdate('eventsdev', $flds, '`RowID` = "'.$rowid.'";');
...
<h3 style="color: red; " id="X">DEV Update Completed.</h3>
  ';
  }   // END UPDATE ACTION 
...
$sql = "SELECT * FROM `eventsdev` WHERE `RowID` = '$rowid';";
...
<h2>DEV Event Update</h2></td>
<td align="center"><br>
<a class="clk" href="devupdateevent.php?ptr=<?=$nav['start']?>"><span title="START" class="glyphicon glyphicon-fast-backward" style="color: blue; font-size: 20px;"></span></a>&nbsp;&nbsp;
<a class="clk" href="devupdateevent.php?ptr=<?=$nav['prev']?>"><span title="PREV" class="glyphicon glyphicon-step-backward" style="color: blue; font-size: 20px;"></span></a>&nbsp;&nbsp;
<a href="devlister.php" class="clk btn btn-primary">SEARCH</a>&nbsp;&nbsp;
<a class="clk" href="devupdateevent.php?ptr=<?=$nav['next']?>"><span title="NEXT" class="glyphicon glyphicon-step-forward" style="color: blue; font-size: 20px;"></span></a>&nbsp;&nbsp;
<a class="clk" href="devupdateevent.php?ptr=<?=$nav['last']?>"><span title="LAST" class="glyphicon glyphicon-fast-forward" style="color: blue; font-size: 20px;"></span></a><br>
</td>
<script>
...
<br>
<!-- <a class="clk" onclick="return confirmContinue()" href="devlister.php?rowid=<?=$r['RowID']?>&action=delete"><span title="Remove THIS Event from the database." class="glyphicon glyphicon-trash" style="color: blue; font-size: 30px;"></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
...
<form id="F1" action="devupdateevent.php" method="post" onsubmit="return validate()">
<table border="1">
...
if ($res->num_rows == 0) {
	...
	<br><br>';
	echo '<a class="btn btn-danger" href="devlister.php">RETURN</a></body></html>';
	exit;
	}
